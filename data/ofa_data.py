...
class OFAPygDataset(InMemoryDataset, ABC):
    ...
    def add_text_emb(self, data_list, texts_emb:list[torch.Tensor]) -> tuple[pyg.data.Data, Mapping]:
        """
        Process and store text vector representations.

        :param data_list: a list of pyg.data.Data generated by self.gen_data
        :param texts_emb: a list of torch.Tensor generated by self.encoder from the text generated by self.gen_data
        """
        pass
    ...
    def get_edge_list(self, mode="e2e") -> dict[str, list]:
        ...
        :param mode: a string representing the task
        :return: a dictionary whose keys are the connection types including
