...
from task_constructor import LowResourceTaskConstructor


def main(params):
    encoder = SentenceEncoder("ST")

    tasks = LowResourceTaskConstructor(["arxiv_fs", "arxiv_zs", "cora_fs", "cora_zs", "fb_fs", "fb_zs", "wn_fs", "wn_zs"], encoder)
